...
using RegistrationWebApp.Attributes;
...
public class FormOrganisation
{
    ...
    /// <summary>
    /// Does the organisation contact person agrees to be bound by the terms of
    /// licence agreement?
    /// </summary>
    [MustBeTrue(ErrorMessage = "You must accept the licence conditions to continue.")]
